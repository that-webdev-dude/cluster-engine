class PhysicsWorld {
  ...
  static applyFriction(entity, frictionValue) {
    this.applyForce(
      entity,
      entity.velocity.clone().unit().reverse().scale(frictionValue)
    );
  }
...
//       resolutionVector.clone().scale(source.inverseMass)
//     );
//     target.position.subtract(
//       resolutionVector.clone().scale(-target.inverseMass)
//     );
//   }
...
//     let separatingVelocityDifference =
//       separatingVelocityScaled - separatingVelocity;

//     let impulse =
//       separatingVelocityDifference / (source.inverseMass + target.inverseMass);
